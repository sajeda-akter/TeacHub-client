            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-5 justify-items-center content-center  lg:w-10/12 mx-auto">
                {
                    brands.map(product=>
                        ...
                        <figure><img src={product.img} className="w-full h-52" alt={product.name}/></figure>
                        <div className="card-body">
                          <h2 className="card-title text-3xl text-[#E94560] text-center">Brand : {product.name}</h2>
